...
## Visualizing slides without modmod

```bash
cd modmod/include/slides
npm i
export PATH=$PATH:$PWD/node_modules/.bin/
cd -
```

now you can use the `slidev` command to work on slides. Example:

```bash
cd content/mods/A-foundations/topics/basic-syntax/
